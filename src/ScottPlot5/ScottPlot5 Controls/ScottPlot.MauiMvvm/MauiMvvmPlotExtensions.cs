...
internal static class MauiMvvmPlotExtensions
{
    ...
    internal static void ProcessPanUpdated(this UserInputProcessor processor, MauiMvvmPlot plot, PanUpdatedEventArgs e)
    {
    ...
    internal static void ProcessPinchUpdated(this UserInputProcessor processor, MauiMvvmPlot plot, PinchGestureUpdatedEventArgs e, float width, float height)
    {
    ...
    internal static void ProcessMouseDown(this UserInputProcessor processor, MauiMvvmPlot plot, SKTouchEventArgs e)
    {
    ...
    internal static void ProcessMouseUp(this UserInputProcessor processor, MauiMvvmPlot plot, SKTouchEventArgs e)
    {
        Pixel pixel = e.Location.ToPixel();
    ...
    internal static void ProcessMouseMove(this UserInputProcessor processor, MauiMvvmPlot plot, SKTouchEventArgs e)
    {
        Pixel pixel = e.Location.ToPixel();
    ...
    internal static void ProcessWheelChanged(this UserInputProcessor processor, MauiMvvmPlot plot, SKTouchEventArgs e)
    {
        Pixel pixel = e.Location.ToPixel();
    ...
    internal static void ProcessZoomAll(this UserInputProcessor processor, MauiMvvmPlot plot, TappedEventArgs e)
    {
